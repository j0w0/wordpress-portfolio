    ...
    <body <?php body_class(); ?>>
        ...
        <header id="masthead">
            ...
            <div id="masthead-main">
                <a id="logo" href="<?= get_site_url(); ?>">
                    <img src="<?= get_template_directory_uri(); ?>/assets/images/logos/web-logo.svg" alt="Josh Woodcock, Designer and Developer" id="logo-img" />
                    <div id="logo-type">
                        Josh Woodcock<br />
                        Web Dev & UX Design
                    </div>
            ...
            <section id="above-the-fold">
                <div class="container-fluid container-max-width">
                    ...
                    <div id="home-intro" class="text-center">
                        ...
                        <a href="<?= get_site_url(); ?>/portfolio" class="btn btn-outline-primary btn-lg btn-secondary-font mt-3">View All My Work</a>
                    </div>
