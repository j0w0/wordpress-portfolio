...
if ($seiPostsQuery->have_posts()) { ?>
    ...
    <div class="post-container mb-5">
        <p>I am a Front-End Developer & UX Designer experienced in building reliable, manageable, and scalable websites and web applications. I develop quality products by utilizing appropriate technologies and applying best practices for data organization and code optimization. While the projects below are for more visual representation, <a href="https://www.github.com/j0w0" target="_blank">check out my GitHub</a> to view my code.</p>
    </div>
            ...
            <div class="col-sm-6 col-lg-3 portfolio-thumbnail-box mb-5">
                <a href="<?php the_permalink(); ?>">
                    <div class="embed-responsive embed-responsive-1by1 box-shadow">
                        <div class="portfolio-thumbnail embed-responsive-item" style="background-image: url('<?= $projectThumbnail; ?>');">
                    ...
                    <div class="portfolio-thumbnail-info">
                        ...
                        <span class="portfolio-thumbnail-category"><?= $projectCategory; ?></span>
                    </div>
                </a>
            </div>
